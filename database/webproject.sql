...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2021 at 07:39 PM
...
INSERT INTO `customers` (`id`, `name`, `phone`, `email`, `country`) VALUES
(1, 'Scott Galloway', '(384) 736-4580', 'suspendisse.eleifend@nequemorbiquis.net', 'Nigeria'),
(2, 'Abbot Oliver', '1-358-615-6573', 'ut.tincidunt@temporbibendum.org', 'Netherlands'),
(3, 'Raya Briggs', '1-143-255-8643', 'orci@inornare.net', 'Netherlands'),
(4, 'Tad Johns', '(562) 285-9824', 'mauris.aliquam@neque.co.uk', 'New Zealand'),
(5, 'Kimberly Blankenship', '1-655-275-7433', 'ipsum@porttitoreros.com', 'Peru');
...
CREATE TABLE `districts` (
  `districts_id` varchar(6) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `districts` (`districts_id`, `zip_code`, `name_th`, `name_en`, `amphure_id`) VALUES
...
INSERT INTO `geographies` (`geo_id`, `name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
INSERT INTO `login` (`user_id`, `first_name`, `last_name`, `username`, `email_address`, `password`) VALUES
...
(5, 'bb', 'bb', 'b', 'b', '$2y$10$7.9zpawAWkkofYhKh4CUa.IGYTi2fk/ZrCLOYDZa1q2fxd/fl7KT.');
...
CREATE TABLE `tbadmin` (
  `add_username` varchar(70) NOT NULL,
  `add_password` varchar(60) NOT NULL,
  `add_firstname` varchar(80) NOT NULL,
  `add_lastname` varchar(80) NOT NULL,
  `add_idcardnumber` char(13) NOT NULL,
  `add_phone` char(10) NOT NULL,
...
--
-- Table structure for table `tbgive_status`
--

CREATE TABLE `tbgive_status` (
  `give_id` int(4) NOT NULL,
  `give_name` varchar(30) NOT NULL,
  `give_note` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbgive_status`
--

INSERT INTO `tbgive_status` (`give_id`, `give_name`, `give_note`) VALUES
(1, 'ยังไม่ได้รับเตียง', '-'),
(2, 'ได้รับเตียงแล้ว', '-');
...
CREATE TABLE `tbprefix` (
  `prefix_id` int(1) NOT NULL,
  `pre_th_name` char(10) NOT NULL,
  `pre_eng_name` char(10) DEFAULT NULL,
  `pre_ab_th` char(10) DEFAULT NULL,
  `pre_ab_eng` char(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbprefix` (`prefix_id`, `pre_th_name`, `pre_eng_name`, `pre_ab_th`, `pre_ab_eng`) VALUES
(1, 'นาย', 'Mister', 'นาย', 'Mr.'),
...
INSERT INTO `tbroles` (`roles_id`, `roles_name`) VALUES
(1, 'user'),
(2, 'admin');
...
--
-- Table structure for table `tbsex`
--

CREATE TABLE `tbsex` (
  `sex_id` int(1) NOT NULL,
  `sex_name` char(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbsex`
--

INSERT INTO `tbsex` (`sex_id`, `sex_name`) VALUES
(1, 'หญิง'),
(2, 'ชาย');
...
--
-- Table structure for table `tbsick_bed`
--

CREATE TABLE `tbsick_bed` (
  `sick_id` int(4) NOT NULL,
  `sick_name` varchar(255) NOT NULL,
  `sick_amount` int(4) NOT NULL,
  `sick_note` varchar(100) DEFAULT NULL,
  `sit_id` int(1) NOT NULL,
  `user_username` varchar(70) DEFAULT NULL,
  `date_add` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `districts_id` varchar(6) DEFAULT NULL,
  `province_id` int(5) DEFAULT NULL,
  `amphure_id` int(5) DEFAULT NULL,
  `village` int(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Table structure for table `tbsick_status`
--

CREATE TABLE `tbsick_status` (
  `sit_id` int(1) NOT NULL,
  `sit_name` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `tbsick_status`
--

INSERT INTO `tbsick_status` (`sit_id`, `sit_name`) VALUES
(1, 'เตียงไม่ว่าง'),
(2, 'เตียงว่าง');
...
--
-- Table structure for table `tbsick_want`
--

CREATE TABLE `tbsick_want` (
  `sickw_id` int(4) NOT NULL,
  `sickw_name` varchar(255) NOT NULL,
  `sickw_amount` int(4) NOT NULL,
  `sickw_note` varchar(100) DEFAULT NULL,
  `sickw_want_date` date DEFAULT NULL,
  `sickw_date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `user_username` varchar(70) DEFAULT NULL,
  `give_id` int(4) NOT NULL,
  `province_id` int(5) DEFAULT NULL,
  `amphure_id` int(5) DEFAULT NULL,
  `village` int(1) DEFAULT NULL,
  `districts_id` varchar(6) DEFAULT NULL,
  `datebetween` varchar(40) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbusers` (
  ...
  `user_passwords` varchar(60) NOT NULL,
  ...
  `districts_id` int(4) NOT NULL,
  `user_passwords_conf` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tbusers` (`user_username`, `user_passwords`, `user_firstname`, `user_lastname`, `user_email`, `user_phone`, `user_create`, `prefix_id`, `sex_id`, `province_id`, `roles_id`, `amphure_id`, `districts_id`, `user_passwords_conf`) VALUES
('admin', '$2b$12$nBjBjbuhM0DFi3Y/LlstnOYDr8505MCHTQ2UFdITANSYnUVkhfiCi', 'admin', 'admin', 'admin@hotmail.com', '0834016682', '2021-11-12 16:31:45', 1, 2, 70, 2, 931, 901402, NULL),
('jwt', '$2b$12$EadgUWiknXrJQSdHYM2Kl.MM.JKEXsE7q.hSjU7W5eCe56oIUkGoq', 'โชคชัย', 'แจ่มน้อย', 'zzzzzz', '0834015555', '2021-11-12 15:56:43', 1, 2, 64, 1, 866, 810303, NULL),
('madeieijung', '$2b$12$GX5xASeBXXYJ2y7hfE.Q9OFjTK54QsCTGMIdCveKaAKlBLFf.4xlS', 'sadasd', 'sadasdas', 'dasdasd', 'asdasdas', '2021-10-22 08:01:08', 1, 2, 1, 1, 4, 100402, NULL),
('mazikdot11', '$2b$12$ctwlmMK5vzNoc/guxLOYw.eJ6JNG.ClcH3f696e1flefn2ncRWjnS', 'sad', 'asdasdsa', 'asdasdasd', 'sadsad', '2021-10-16 09:15:25', 2, 1, 34, 1, 513, 460303, NULL),
('mazikdot115', '$2b$12$UFBpIgA70ycYxiNiG2M58.mqj3wwAYMb33u8N9uxHbjEHlKUcOC7S', 'asdas', 'dasdasdasd', 'dsadasd', 'sadsdas', '2021-11-06 07:48:55', 3, 2, 34, 1, 513, 460302, NULL),
('mazikdot123', '$2b$12$NcOc3WeS6gk48.nen5VPAOW0V9ZtJNq5QQrpWrKgfXk1s/PHz928K', 'มูฮำหมัด', 'ปูตีล่า', 'mad@hotmail.com', '0834016682', '2021-11-10 05:17:01', 1, 2, 58, 1, 808, 730213, NULL),
('mazikdot123a', '$2b$12$rv3Y6pjNQckpRdhz17eFfufyFFGOgvzCr7votDYnyXynJwgHFDZla', 'asdas', 'dasdasdas', 'dsadasdasd', 'asdasdas', '2021-10-24 12:10:23', 2, 1, 1, 1, 3, 100302, NULL),
('mazikdot15', '$2b$12$oC5tTBRA7qzVzSh4juo62OnpmDS7JUEnxqeRdF8amZ7xnuP0GUEoS', 'sadsa', 'dasdsad', 'sadasd', 'sadsad', '2021-10-29 04:51:24', 2, 2, 56, 1, 784, 710302, NULL),
('mazikdot175', '$2b$12$MZ82RujsLCJ49ARYEHLjsuSIrD9hgY/c7nZVQPZY9fADNI3PBTqse', 'asdas', 'dasdasd', 'asdasasdasd', 'asdasd', '2021-10-22 05:06:42', 1, 2, 28, 1, 396, 400405, NULL),
('mazikdot55', '$2b$12$p5a5mcAknNRxeeis3hy4GuvbXMRZ7pNBbB9/vxkNgPs/ZDOyYKiBy', 'มูฮำหมัด', 'ปูตีล่า', 'mazikdot@hotmail.com', '0834016682', '2021-10-06 14:55:27', 1, 2, 17, 1, 203, 260202, NULL),
('mazikdot66', '55', 'sadas', 'dasdsad', 'asdasd', 'asdasd', '2021-10-13 16:28:27', 1, 2, 50, 1, 723, 630404, NULL),
('mazikdot667', '$2b$12$4z6.pcmKis8XPkzbXuYua.ya0tbh.I9FTly71MhJufytFOOsxsQyK', 'sasa', 'assas', 'asdsadsad', 'asas', '2021-10-13 05:43:45', 1, 1, 34, 1, 513, 460303, NULL),
('mazikdot882', '$2b$12$snz1lVSkBeL0bc.FV2KRE.jcKyvuOZ5blTAibT4UB09cHyK8ToonG', 'asdsad', 'sadsadsad', 'sadasdasdsa', 'asdasd', '2021-11-02 09:24:56', 3, 1, 17, 1, 203, 260202, NULL),
('mazikdot99', '$2b$12$fUSw2vKh9NJbaGbaOuQfMueTvEW3aLgJahDEEtNaPCKgFmePzRtkK', 'asdasd', 'sadasd', 'sadasdsa', 'asdasd', '2021-10-16 08:57:45', 3, 1, 56, 1, 783, 710203, NULL),
('mazikdot9997', '$2b$12$tVPPTlAa1EcQERZlqalIhOerarNal5ZfqTxenzc6fvnZV2pTIxO2q', 'sadasdsadas', 'dasdasdsad', 'chalongchai@hotmail.com', '626', '2021-11-09 14:08:30', 2, 1, 70, 1, 918, 900103, NULL),
('mazikdot9999', '$2b$12$6jwIz4t819Hz4EKd9ySw6OP7QMNmgUSVNOynT4gysPSI96a2eokqm', 'sadas', 'dsadas', 'asd', 'asdasd', '2021-11-04 04:37:24', 1, 2, 70, 1, 918, 900103, NULL),
('mazikdotasdsad', '$2b$12$Xqif2UuV4nbhKDL0dkmlK.I6neNEifK2q/0q.un6Edq7HN5QSXNh.', 'ฟหกฟห', 'กฟหกฟห', 'ฟหกฟหกฟห', 'หฟกฟหก', '2021-10-24 15:28:30', 1, 1, 17, 1, 203, 260201, NULL),
('mazikdoteieiei', '$2b$12$5Q2MdvHZFYsGJLLijTjg5.0THk8fQDFbye/WvjREg..DdNQok/ssC', 'sadas', 'dasdasd', 'asdasd', 'sadsad', '2021-10-16 10:05:32', 2, 1, 56, 1, 785, 710406, NULL),
('mazikdotest', '$2b$12$Ui1eRF/6wZLBJcpzAO11V.jiPE31vK61DiHJJjAR8UzBYMCwTjCrG', 'sadasd', 'asdsad', 'sadasdsad', 'asdasd', '2021-10-16 10:04:42', 2, 2, 34, 1, 514, 460401, NULL),
('mazikdotkk', '$2b$12$.UlhoI1DbmsiegIk9Y3bzOBYBdz2RppseNS75vE5R.OyyAaawHuHy', 'asd', 'asdasdasd', 'sadsadasd', 'asdasd', '2021-10-26 10:27:16', 1, 1, 58, 1, 808, 730202, NULL),
('muhammadputeela', '$2b$12$z.jwQVa9BfAp4RQjjct1ee2qqL7zTYhVfV2t9tpqbvzXFJGVtey52', 'มูฮำหมัด', 'ปูตีล่า', 'mazikdot@rmutsvmail.com', '0834016682', '2021-11-07 20:05:21', 1, 2, 70, 1, 931, 901402, NULL),
('muhammadputeelaz', '$2b$12$YTboO4w48fGhtyEzhDfzzeRym3XKeo3nDTuu/opiBEipoP4Cp7gHW', 'มูฮำหมัด', 'ปูตีล่า', 'asdasd@hotmail.com', '0834016681', '2021-11-12 18:16:31', 1, 2, 36, 1, 549, 480101, NULL),
('qqqazzz', '$2b$12$/BzE6WvJGeGfFFLkTVa2peFphZXB0eirwFKdHyACnQ3vH/Zfv5mwS', 'asdas', 'dasdsad', 'sadsad', 'asdsad', '2021-10-23 11:41:28', 2, 1, 58, 1, 807, 730117, NULL),
('qqqqqqqqqqq', '$2b$12$cTVHmZpIxz3.5gh/lMp36OqKgWK45hNl7nmVdSjYl8oPUh1okbZBe', 'sadsa', 'dsadasd', 'sadasdsa', 'sadsad', '2021-10-16 04:24:58', 2, 2, 56, 1, 783, 710202, NULL),
('qqqqqqqqqqqqq', '$2b$12$4aiYOoWivQDjB/taHYAd8O4WsZaMHsyT7WToLyIu/6j3D//cM9ek6', 'sadsa', 'dsadsad', 'asas', 'sadasd', '2021-10-16 04:21:39', 2, 2, 56, 1, 782, 710103, NULL),
('qqqqqqqqqqqqqqz', '$2b$12$bVyWhEj8sBKX8QrIehBz9.sZOtp.lcgcysQ5ltwgGu3tuwxA5IWca', 'sadas', 'dsadasd', 'asdsad', 'ssadasd', '2021-10-16 08:51:29', 1, 1, 49, 1, 712, 620403, NULL),
('qweqweasdasd', '$2b$12$u3QeiSctX6KyJ1IRkxLKrOkTq/FjXuiiRDNpzxbeiIpX7NdOaTQGm', 'sadsad', 'qwdqwdw', 'sadsadsa', 'dqwd', '2021-10-16 04:06:39', 3, 1, 34, 1, 515, 460504, NULL),
('qwqwazaza', '$2b$12$6OwWqJKfiyxGJoreSPMoCeCY81lNTN1Gx0PKZNH..02dxsHmIt3F.', 'asdasd', 'asdsadsa', 'asdasd', 'asdasdasd', '2021-10-24 12:07:31', 2, 1, 56, 1, 783, 710202, NULL),
('qzz', '$2b$12$C3GASqBINl2xvxHMhZYZf.QpzSwm/7s9dIm63FmktVuc9VXoxLWj.', 'adsadsa', 'dsadsad', 'sadsadsd', 'sadasd', '2021-10-16 04:12:59', 2, 1, 50, 1, 726, 630701, NULL),
('sad', '$2b$12$d8acLIqmOF726dk2F8AG..yGaF.1BJpKVdbVGAFNGdml8YNC0hU8G', 'asdsa', 'sadsa', 'sadsad', 'asdsad', '2021-10-16 04:10:49', 1, 1, 58, 1, 807, 730117, NULL),
('sadasd', '$2b$12$TaewpmXNBi6IJtbm6cXm1uyQA90FxR/fCrpzVXccuOiw.tfP0JJ.q', 'asdasd', 'asdasdasd', 'sadsadsad', 'asdasd', '2021-10-07 13:13:11', 2, 1, 1, 1, 7, 100701, NULL),
('sadasdaa', '$2b$12$55E5GVP7pJc2covff2d7..k2zCRkPD4.v/dCSdXTPuEPaxIjdQ3Zm', 'asdas', 'dsadasd', 'sadasdsa', 'sadsad', '2021-10-23 11:40:05', 2, 1, 58, 1, 809, 730316, NULL),
('sadasdas', '$2b$12$sYzhPkaj41TQ2npThgetseZdCcvwK0uJXlz0M.tHu9uljPaVyXBnO', 'sadas', 'dasdsa', 'dasdasdasd', 'asdsad', '2021-10-23 11:38:53', 1, 1, 58, 1, 807, 730116, NULL),
('sadasdasdsa', '$2b$12$i.zSDb2NeQRvVn71VLQIiO3bLe3XUFdNZ2awN09B60zwqLM1rqMne', 'sadasd', 'asdasdas', 'sadsadasd', 'asdasd', '2021-10-24 12:07:54', 1, 1, 34, 1, 514, 460401, NULL),
('sadasdqdq', '$2b$12$Q6FGElgH0qLiD2DKRL7GneLFl.3pKg2wC5SXKiwLVGeme6/OSp1Ny', 'asdas', 'dasdasd', 'sadasd', 'sadsad', '2021-10-24 11:57:26', 2, 1, 34, 1, 513, 460302, NULL),
('sadasdqq', '$2b$12$gMmwLT7Nh6hhCCVSb1j/0.ePmJEBXYUknXp3sgizlQ2PT1wD31C62', 'asdsad', 'asdasd', 'asdasd', 'asdasd', '2021-10-16 08:52:19', 2, 2, 56, 1, 785, 710403, NULL),
('sadasdwqwq', '$2b$12$hK9QGlSQo9P9uIhr/QLIeurmjyPBEr9CrJefKnsjyKQtj3xQW0tvq', 'sad', 'sadsad', 'qwasdasd', 'asdasd', '2021-10-16 04:05:24', 1, 2, 56, 1, 785, 710402, NULL),
('sadasdwqwqz', '$2b$12$r95oPoywzvav2yYK0UjMH.OHsgbW1dluTPwXxVUhg3t5yEHNcVwym', 'sad', 'sadsad', 'qwasdasd', 'asdasd', '2021-10-16 04:05:51', 1, 2, 56, 1, 785, 710402, NULL),
('sadasdwqwqzq', '$2b$12$.UWmyrU9U99XB575DxtxTOyFnPLgnoiOwimE4CFTU0WlT3FFsV1/O', 'sad', 'sadsad', 'qwasdasd', 'asdasd', '2021-10-16 04:06:18', 1, 2, 56, 1, 785, 710402, NULL),
('sadasdww', '$2b$12$GpgZbXwutF.YPm1axkzdb.6bLeDyL/mV1FI900puDnraqxC9RcPhy', 'sadsa', 'dsadsadsad', 'sadsadsad', 'sadsad', '2021-10-08 14:58:52', 1, 1, 14, 1, 175, 230506, NULL),
('sadasdwww', '$2b$12$RnrxBSYgG7IsohHkw48aIeRGYbiKErEaoFGDXXQJ2phs/QT9iFzS.', 'sadas', 'dsadsad', 'sadasdsa', 'sadasd', '2021-10-13 04:39:06', 1, 1, 49, 1, 711, 620302, NULL),
('sadasdza', '$2b$12$jFrM5gtzBzsyliyD462Vw.SyiZTseLC2FDQMJRmaRLtBVlnwqWJJW', 'asdasd', 'asdasd', 'asdsadasd', '0836530374', '2021-11-02 02:42:02', 1, 2, 58, 1, 809, 730316, NULL),
('sadqqazasasa', '$2b$12$CopuL7tGJX5HBKrrh1zm4OyfqbMuj6.LH6LyPHy9XdIOwIrV7jovm', 'asdsad', 'sadasdsa', 'dasdasdsa', 'sadasdas', '2021-10-24 12:09:23', 2, 1, 64, 1, 867, 810402, NULL),
('sadqwdqwdqw', '$2b$12$i1IP8Ky.t16fIhPSaHXMBuq86MtUCGJKTDlEpi9b08hXejcQe9zgi', 'sadasd', 'asdsadsa', 'sadasdasd', 'sadasd', '2021-10-16 04:17:17', 1, 1, 56, 1, 785, 710403, NULL),
('sadsad', '$2b$12$/J1ryzLrYy8FikMgCTGX8OORBx/DjbRqN7yDQTNY.o10cE.MAlea6', 'asdasd', 'sadasd', 'sasadsad', 'sadsad', '2021-10-24 11:57:01', 2, 1, 50, 1, 728, 630902, NULL),
('sadsadas', '$2b$12$hU.Wbo82GmKQOEEh4CZuXenPfFOx45WKdqQRBUBqN3zmX9/2RKhhu', 'sadsa', 'dsadasd', 'sadasdas', 'asdasd', '2021-10-23 11:39:40', 1, 2, 17, 1, 202, 260102, NULL),
('sadsadasza', '$2b$12$ZLa4tn1SJQdiHyE9JTb9Beb3qMkWE309r1IMij/cfb6nfIH9x3em6', 'sadsa', 'dsadsadas', 'dasdasd', 'asdasdas', '2021-11-07 20:02:31', 3, 1, 1, 1, 3, 100303, NULL),
('sadsadsa', '$2b$12$/flg5BeKrTjJq3kHqplx6u9lyBwPvhNpT.3dNekmwAgIu/OMKqN.O', 'sadsad', 'sadsadsad', 'sadasdsad', '08365sad', '2021-10-23 19:14:41', 2, 1, 56, 1, 785, 710402, NULL),
('sadsadsad', '$2b$12$rPZxrgkRvJQqQuawnCM62O1PZ3gtRLNpO15I8ZMfAssX9cv095oXm', 'sada', 'sdasdsad', 'sadasd', 'asdsad', '2021-10-12 17:17:25', 2, 1, 34, 1, 514, 460403, NULL),
('sadsadsada', '$2b$12$821V9ncK7bqAPqba2jiqCePnwayLsorkTFL.87BObhCqGfvUy6Xim', 'asdsad', 'sadsad', 'asdsadasd', 'sadasd', '2021-10-23 15:06:28', 2, 1, 64, 1, 866, 810303, NULL),
('sadsadsadz', '$2b$12$wQ.4.Bcr9KcXzL92F9uwi.kYP//IEXvCxbWAJZ46YsqMLW19tf7CK', 'sadsad', 'sadasd', 'asdasd', 'sadsad', '2021-10-23 11:40:31', 3, 1, 17, 1, 203, 260203, NULL),
('sadsadsadzz', '$2b$12$Ty.5ojx2HUsbnhsG/7KNuOjzGvDojAFC77tURHt9U2RsIc8qUWlMq', 'asdas', 'dsadsad', 'qwdasdasd', 'sadasd', '2021-10-16 04:07:34', 2, 2, 56, 1, 785, 710405, NULL),
('sadsadsadzzqq', '$2b$12$tJZREGx/dObmrHZqoerUdenn0JJcg2T0lWepxVQU5eBcNLATEdERK', 'asdas', 'dsadsad', 'qwdasdasd', 'sadasd', '2021-10-16 04:08:40', 2, 2, 56, 1, 785, 710405, NULL),
('sadsadsaza', '$2b$12$dShY2deWuOV6UxIA6G8Bo.gJbwOCkuvBLVeEkPM7thwCER5.tuhZ.', 'asd', 'asdasdsa', 'sadsad', 'sadsad', '2021-10-24 11:58:05', 2, 1, 34, 1, 514, 460403, NULL),
('sadsadza', '$2b$12$Xo3ayAcmwbK6ZRerHibpJuv5ikcNj0lvFj6.yMYFp6/psORIqhg3C', 'sadasd', 'asdasd', 'sadsad', 'asas', '2021-10-23 15:07:44', 1, 1, 56, 1, 784, 710303, NULL),
('sadzsasasaq', '$2b$12$G4Jv.kb0/aHmBP5OAnSnf.PjYCieUR6Cl76vbN4dNh/G5R8cm2xQS', 'asdsaqzzvv', 'sadsaqqzz', 'sadsad', 'asdsad', '2021-10-16 04:11:45', 1, 1, 58, 1, 807, 730117, NULL),
('sadzsasasaqqw', '$2b$12$vNqtIBuHPh6o3dZelVOhweEVissSQJv3ROu3TJQbHSpAejuyOVSLu', 'asdsaqzzvv', 'sadsaqqzz', 'sadsad', 'asdsad', '2021-10-16 04:12:29', 1, 1, 58, 1, 807, 730117, NULL),
('ssssssss', '$2b$12$PNDuPpUIJSIAMdA2pY05bOB2dROo5cigejJJ9aDHkBHmQaHhLduvS', 'asdas', 'dasdasd', 'asdsadas', 'sadsadsad', '2021-10-16 04:15:10', 2, 1, 34, 1, 514, 460401, NULL),
('suhaimee', '$2b$12$FcnqVjDZDNhAM908BLHdlu9SDKnYa.V6/D1HvcaopQkcQwKi85Lca', 'suhaimee', 'yahkoh', 'suhaimee@hotmail.com', '088748963', '2021-11-06 09:39:24', 1, 2, 75, 1, 979, 950301, NULL),
('test1', '55', 'มูฮำหมัด', 'ปู', 'sadasdsa', 'asdasd', '2021-10-13 18:10:09', 1, 2, 58, 1, 809, 730316, NULL),
('w123', '$2b$12$xYTFTDwlIVZq4vxnTjpGNurQXL.wm4UfTYppYpUPxPr2dsIPAsRIq', 'asdsa', 'dsadsad', 'sadsad', 'sadsasad', '2021-10-16 04:26:00', 1, 1, 56, 1, 785, 710402, NULL),
('waaa', '$2b$12$T1MHWlnNA8.T0D/yIIhob.R2BBLiMOir./t7IBoGuxIlULC35vNyC', 'sadasd', 'sadasdw', 'asdasdsad', 'sadasd', '2021-10-16 04:36:53', 2, 2, 17, 1, 204, 260308, NULL),
('wwwwwwwwwwww', '$2b$12$.FCHhX93rL8ZXmr.MM4HZuXFZFnJCDk.ErK6jjRDpSm.4XRpgxjaG', 'sadasd', 'asdsad', 'sadsad', 'asdsad', '2021-10-16 04:35:14', 1, 1, 34, 1, 515, 460504, NULL),
('zaza', '$2b$12$4JIdjKgJkR/7hrodEOkRQuAaROQGKGPjRpoADogPuEClm10Tzz792', 'asdasd', 'sadasd', 'sadsad', 'asdasdsa', '2021-10-22 05:05:04', 2, 1, 56, 1, 784, 710303, NULL),
('zzzzzzzzzz', '$2b$12$QRV2YrSAC9NXOIcbFx8NEe9fI2d9uivKMbE4hilpXDS2hrFVTpawy', 'qsas', 'asas', 'dasdsad', 'asdas', '2021-10-16 04:13:32', 1, 2, 58, 1, 807, 730117, NULL);
...
(1, 'mazikdot123', 'mazikdot@hotmail.com', '$2a$08$eWiLkTNqMyUf/aZVarORMeS1.YqPVgQTD6l8pZFvFFxpmygIEIUjW', '2021-10-21 15:26:22', '2021-10-21 15:26:22');
...
--
ALTER TABLE `tbadmin`
  ADD PRIMARY KEY (`add_username`),
  ADD KEY `prefix_id` (`prefix_id`),
  ADD KEY `roles_id` (`roles_id`);

--
-- Indexes for table `tbgive_status`
--
ALTER TABLE `tbgive_status`
...
--
-- Indexes for table `tbsex`
--
ALTER TABLE `tbsex`
  ADD PRIMARY KEY (`sex_id`);

--
-- Indexes for table `tbsick_bed`
--
ALTER TABLE `tbsick_bed`
...
--
-- Indexes for table `tbsick_status`
--
ALTER TABLE `tbsick_status`
  ADD PRIMARY KEY (`sit_id`);

--
-- Indexes for table `tbsick_want`
--
ALTER TABLE `tbsick_want`
  ADD PRIMARY KEY (`sickw_id`),
  ADD KEY `give_id` (`give_id`),
  ADD KEY `user_username` (`user_username`),
  ADD KEY `districts_id` (`districts_id`),
  ADD KEY `province_id` (`province_id`),
  ADD KEY `amphure_id` (`amphure_id`);
...
--
-- AUTO_INCREMENT for table `tbgive_status`
--
ALTER TABLE `tbgive_status`
  MODIFY `give_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbsick_bed`
--
ALTER TABLE `tbsick_bed`
  MODIFY `sick_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT for table `tbsick_want`
--
ALTER TABLE `tbsick_want`
  MODIFY `sickw_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `amphures`
  ADD CONSTRAINT `amphures_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`province_id`) ON UPDATE CASCADE;

--
-- Constraints for table `districts`
--
ALTER TABLE `districts`
  ADD CONSTRAINT `districts_ibfk_1` FOREIGN KEY (`amphure_id`) REFERENCES `amphures` (`amphure_id`) ON UPDATE CASCADE;

--
-- Constraints for table `provinces`
--
ALTER TABLE `provinces`
  ADD CONSTRAINT `provinces_ibfk_1` FOREIGN KEY (`geo_id`) REFERENCES `geographies` (`geo_id`) ON UPDATE CASCADE;

--
-- Constraints for table `tbadmin`
--
ALTER TABLE `tbadmin`
  ADD CONSTRAINT `tbadmin_ibfk_1` FOREIGN KEY (`prefix_id`) REFERENCES `tbprefix` (`prefix_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbadmin_ibfk_2` FOREIGN KEY (`roles_id`) REFERENCES `tbroles` (`roles_id`) ON UPDATE CASCADE;

--
-- Constraints for table `tbsick_bed`
--
ALTER TABLE `tbsick_bed`
  ADD CONSTRAINT `tbsick_bed_ibfk_1` FOREIGN KEY (`sit_id`) REFERENCES `tbsick_status` (`sit_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_bed_ibfk_2` FOREIGN KEY (`user_username`) REFERENCES `tbusers` (`user_username`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_bed_ibfk_3` FOREIGN KEY (`districts_id`) REFERENCES `districts` (`districts_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_bed_ibfk_4` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`province_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_bed_ibfk_5` FOREIGN KEY (`amphure_id`) REFERENCES `amphures` (`amphure_id`) ON UPDATE CASCADE;

--
-- Constraints for table `tbsick_want`
--
ALTER TABLE `tbsick_want`
  ADD CONSTRAINT `tbsick_want_ibfk_1` FOREIGN KEY (`give_id`) REFERENCES `tbgive_status` (`give_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_want_ibfk_2` FOREIGN KEY (`user_username`) REFERENCES `tbusers` (`user_username`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_want_ibfk_3` FOREIGN KEY (`districts_id`) REFERENCES `districts` (`districts_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_want_ibfk_4` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`province_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbsick_want_ibfk_5` FOREIGN KEY (`amphure_id`) REFERENCES `amphures` (`amphure_id`) ON UPDATE CASCADE;

--
-- Constraints for table `tbusers`
--
ALTER TABLE `tbusers`
  ADD CONSTRAINT `tbusers_ibfk_1` FOREIGN KEY (`prefix_id`) REFERENCES `tbprefix` (`prefix_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbusers_ibfk_2` FOREIGN KEY (`sex_id`) REFERENCES `tbsex` (`sex_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbusers_ibfk_3` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`province_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbusers_ibfk_4` FOREIGN KEY (`roles_id`) REFERENCES `tbroles` (`roles_id`) ON UPDATE CASCADE;
